    ...
    return (
      <div className="min-h-screen bg-brand-bg flex items-center justify-center px-4">
        <div className="max-w-md text-center">
          ...
          <h1 className="font-heading text-2xl font-bold text-brand-ocean mb-2">Check your email!</h1>
          <p className="text-slate-500 text-sm">
            We sent a confirmation link to <strong className="text-brand-ocean">{email}</strong>. Click it to activate your account and start exploring.
          </p>
        </div>
      </div>
    );
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200/60">
          ...
          <p className="text-sm text-slate-400 text-center mb-6">
            Create an account to plan trips and save memories
          </p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-xl text-sm text-brand-ocean placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-sky/30 focus:border-brand-sky"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-brand-orange hover:bg-brand-orange-dark disabled:opacity-50 text-white font-semibold rounded-xl transition-colors duration-200 cursor-pointer"
            >
        ...
        <p className="text-center text-sm text-slate-400 mt-6">
          ...
          <Link href="/auth/login" className="text-brand-sky font-semibold hover:text-brand-sky-dark cursor-pointer">
            Sign in
          </Link>
        </p>
      </div>
